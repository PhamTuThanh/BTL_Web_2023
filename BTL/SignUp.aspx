<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="BTL.WebForm2" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class ="center-page">
            ...
            <label class="col-xs-11">Email:<asp:Label ID="Label5" runat="server" Text="Label"></asp:Label></label>
            <div class="col-xs-11">
            ...
            <br /><br />
             <div class="col-xs-11">
                 <asp:Button ID="txtsignup" Class="btn btn-success" runat="server" Text="SignUP" /><asp:Label runat="server" Text="Label"></asp:Label><asp:Label ID="Label2" runat="server" Text="Label"></asp:Label><asp:Label ID="Label3" runat="server" Text="Label"></asp:Label><asp:Label ID="Label4" runat="server" Text="Label"></asp:Label><asp:Label runat="server" Text="Label"></asp:Label><asp:TextBox ID="TextBox1" runat="server" Class="form-control" placeholder="Enter Your Email"></asp:TextBox><asp:Label runat="server" Text="Label"></asp:Label><asp:Label runat="server" Text="Label"></asp:Label><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
            </div>
        </div>
